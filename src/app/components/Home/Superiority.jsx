...
export default function Superiority() {
  const defaultContent =
    "Pena Guru Adalah Website Absensi Untuk Guru, Berisikan Bebereapa Fitur Yang Dapat serta Membantu Mempermudah Absensi Melalui Website";
  const siapa = "Website Pena Guru Dibuat Oleh Murid RPL 2 ....";
  const kenapa =
    "Pena Guru DiBuat Agar Menghemat waktu Dan Mempermudah Staf Maupun Siswa Agar Tidak Menghabiskan Waktu Dengan Mencatat Dan Melaporkan Kehadiran";
  return (
    <>
      <main className="pb-96">
        ...
        <div className=" mt-10 mx-auto p-5">
          <div className="hero-content mx-auto items-center rounded-lg bg-gray-50 grid justify-center sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 ">
            <div>
              <p className="text-2xl text-blue-500 font-bold text-center">
                Ingin Tahu Tentang
              </p>
              <p className="text-2xl text-blue-500 font-bold text-center">
                Pena Guru Lebih Lanjut?
              </p>
            </div>
            <Accordion>
              <AccordionItem
        ...
        <div className="hero mt-10 justify-center mx-auto items-center">
          <div className="hero-content grid justify-center sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 ">
            <div>
              <p className=" text-3xl sm:text-4xl text-blue-500 font-bold text-center">
                Dipersembahkan Oleh
              </p>
            </div>
            <Image
              src={Duivion}
              className=" text-center items-center mx-auto w-32 sm:w-64"
            />
          </div>
        </div>
      </main>
